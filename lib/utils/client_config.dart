...
class ClientConfig {
  ...
  factory ClientConfig.fromEnv() => ClientConfig(
        ...
        clientId: const String.fromEnvironment(_keyClientID),
        clientSecret: const String.fromEnvironment(_keyClientSecret),
      );
...
extension Utils on ClientConfig {
  ...
  Uri get authEndpoint => Uri.https('github.com', 'login/oauth/authorize');
}
