...
import 'package:github_client/src/github_gql/__generated__/github_queries.ast.gql.dart'
    as _i2;
...
abstract class GViewerDetail
  ...
  factory GViewerDetail([void Function(GViewerDetailBuilder b) updates]) =
      _$GViewerDetail;

  static void _initializeBuilder(GViewerDetailBuilder b) => b
    ..operation = _i1.Operation(
      document: _i2.document,
      operationName: 'ViewerDetail',
    );
...
abstract class GPullRequests
  ...
  factory GPullRequests([void Function(GPullRequestsBuilder b) updates]) =
      _$GPullRequests;
...
abstract class GAssignedIssues
  ...
  factory GAssignedIssues([void Function(GAssignedIssuesBuilder b) updates]) =
      _$GAssignedIssues;

  static void _initializeBuilder(GAssignedIssuesBuilder b) => b
    ..operation = _i1.Operation(
      document: _i2.document,
      operationName: 'AssignedIssues',
    );
...
abstract class GRepositories
  ...
  factory GRepositories([void Function(GRepositoriesBuilder b) updates]) =
      _$GRepositories;
