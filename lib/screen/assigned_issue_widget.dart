...
@immutable
final class AssignedIssueWidget extends StatelessWidget {
  const AssignedIssueWidget({super.key, required this.handler});

  final RequestHandler handler;

  @override
  Widget build(BuildContext context) {
    return FuturePageBuilder<Issue>(
      future: handler.assignedIssues,
